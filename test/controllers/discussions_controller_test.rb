...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference("Discussion.count") do
      post discussions_url, params: { discussion: { content: @discussion.content, title: @discussion.title } }, as: :json
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { content: @discussion.content, title: @discussion.title } }, as: :json
    assert_response :success
  end
